...
class StudentController(http.Controller):
    ...
    def get_adm_uni(self, **params):
        ...
        #students_values_date = students_record.read(["id","birthdate","city","country_id","create_uid","current_school","current_school_address","email","first_name","gender","last_name","name","phone","state_id","street_address","write_uid","zip"]) 
        ...
        #fecha_str = students_values_date[1]  

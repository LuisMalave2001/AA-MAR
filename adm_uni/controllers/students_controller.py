...
class StudentController(http.Controller):
    ...
    def get_adm_uni(self, **params):
        ...
        students_values = students_record.read([str("id"),"city","country_id","state_id", "street_address","zip","first_name","last_name","name","email",datetime.date.strftime("birthdate", '%dd/%mm/%YYYY')])
